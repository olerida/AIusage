...
![Version](https://img.shields.io/badge/version-v1.2.2-0A84FF)
...
The current release is **v1.2.2**. Version tags matching `v*` run the test suite, build the universal app, and publish the ZIP through GitHub Actions. The Homebrew cask is maintained separately in `~/Documents/homebrew-tap`.
